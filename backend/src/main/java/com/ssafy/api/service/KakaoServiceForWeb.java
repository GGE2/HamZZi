...
@Service
public class KakaoServiceForWeb {

    private static final Logger log = LogManager.getLogger(KakaoServiceForWeb.class);
    ...
    public String getKakaoAccessToken(String authorize_code) {
        ...
        try {
            ...
            // 서버에 올릴때 주소 바꾸기
            sb.append("&redirect_uri=http://3.35.88.23:8080/api/kakao/web");      // 본인이 설정해 놓은 경로
